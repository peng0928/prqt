...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.url = QtWidgets.QPlainTextEdit(self.scrollAreaWidgetContents)
        self.url.setObjectName("url")
        self.gridLayout.addWidget(self.url, 0, 1, 1, 4)
        self.label_2 = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.datas = QtWidgets.QPlainTextEdit(self.scrollAreaWidgetContents)
        self.datas.setObjectName("datas")
        self.gridLayout.addWidget(self.datas, 1, 1, 1, 4)
        self.label_3 = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 2, 0, 1, 1)
        self.header_2 = QtWidgets.QPlainTextEdit(self.scrollAreaWidgetContents)
        self.header_2.setPlainText("")
        self.header_2.setObjectName("header_2")
        self.gridLayout.addWidget(self.header_2, 2, 1, 1, 4)
        self.verify = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        self.verify.setObjectName("verify")
        self.gridLayout.addWidget(self.verify, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.retry, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.encode, 3, 4, 1, 1)
        self.post = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        self.post.setObjectName("post")
        self.gridLayout.addWidget(self.post, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.log, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.download_delay, 4, 4, 1, 1)
        self.stdout = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        self.stdout.setObjectName("stdout")
        self.gridLayout.addWidget(self.stdout, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.worker, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.download_num, 5, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.task, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.timeout, 6, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.start, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.check_cookie, 7, 4, 1, 1)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 762, 525))
        ...
        self.getheaders = QtWidgets.QPlainTextEdit(self.scrollAreaWidgetContents_2)
        self.getheaders.setObjectName("getheaders")
        self.gridLayout_4.addWidget(self.getheaders, 0, 0, 1, 2)
        self.addheader = QtWidgets.QPlainTextEdit(self.scrollAreaWidgetContents_2)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 762, 525))
        ...
        self.en_str = QtWidgets.QPlainTextEdit(self.scrollAreaWidgetContents_3)
        self.en_str.setObjectName("en_str")
        self.gridLayout_5.addWidget(self.en_str, 2, 1, 1, 1)
        self.de_str = QtWidgets.QPlainTextEdit(self.scrollAreaWidgetContents_3)
        ...
        self.js_tr_2 = QtWidgets.QPlainTextEdit(self.tab_5)
        self.js_tr_2.setObjectName("js_tr_2")
        self.gridLayout_6.addWidget(self.js_tr_2, 0, 0, 1, 1)
        self.add_js_str_2 = QtWidgets.QPlainTextEdit(self.tab_5)
        self.add_js_str_2.setObjectName("add_js_str_2")
        self.gridLayout_6.addWidget(self.add_js_str_2, 0, 1, 1, 1)
        self.run_js = QtWidgets.QPushButton(self.tab_5)
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(10)
        self.run_js.setFont(font)
        self.run_js.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.run_js.setObjectName("run_js")
        self.gridLayout_6.addWidget(self.run_js, 1, 0, 1, 2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.run_js.setText(_translate("Dialog", "启动"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), _translate("Dialog", "运行js"))
        """开始"""
        self.get_data_sqlite()
        self.start.clicked.connect(self.start_btn)
        self.run_js.clicked.connect(self.run_js_btn)
    ...
    def run_js_btn(self):
        ...
        err = './node_err.log'
        nstr = './node_str.js'
        get_js = self.js_tr_2.toPlainText()
        node_str = open(nstr, mode='w', encoding='utf-8')
        node_res = open(res, mode='w', encoding='utf-8')
        node_str.write(get_js)
        node_str.close()
        oldstdout = sys.stdout
        sys.stdout = node_res
        try:
            result = js2py.eval_js(get_js)
            node_res.write(str(result))
            node_res.close()
        except Exception as e:
            node_res = open(res, mode='w', encoding='utf-8')
            node_res.write(str(e))
            node_res.close()
        finally:
            res_fobj = open(res, mode='r', encoding='utf-8')
            sys.stdout = oldstdout
            res_text = res_fobj.read()
            # res_text = res_text[:-4] if res_text[-4:] == 'None' else res_text
            self.add_js_str_2.setPlainText(str(res_text))
            res_fobj.close()
